      ...
      <section className='py-16 px-8 bg-white'>
        ...
        <form
          ...
          onSubmit={(e) => {
            ...
            const mailtoLink = `mailto:manojtalavar9@gmail.com?subject=Message from ${name}&body=Email: ${email}%0D%0A%0D%0A${message}`;
      ...
      <section className='py-16 px-8 bg-gray-100'>
        ...
        <div className='max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center'>
          <div>
            ...
            <p className='text-gray-600'>manojtalavar9@gmail.com</p>
          </div>
          <div>
            <h3 className='text-xl font-bold mb-2'>Phone</h3>
            <p className='text-gray-600'>+91 6360475766</p>
          </div>
          <div>
            <h3 className='text-xl font-bold mb-2'>Address</h3>
            <p className='text-gray-600'>
             UVCE Bengaluru,Karnataka
            </p>
          </div>
        </div>
      </section>
